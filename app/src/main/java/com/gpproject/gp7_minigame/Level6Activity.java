    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (btnFinishLevel != null) {
            btnFinishLevel.setOnClickListener(v -> {
                ...
                if (!currentUser.isEmpty()) {
                    ...
                    Toast.makeText(this, "Level 6 Finished!", Toast.LENGTH_SHORT).show();
        ...
        if (btnUnfinishLevel != null) {
            btnUnfinishLevel.setOnClickListener(v -> {
                ...
                String currentUser = prefs.getString("currentUser", "");
                if (!currentUser.isEmpty()) {
                    prefs.edit().putBoolean(currentUser + "_level_6_finished", false).apply();
                    Toast.makeText(this, "Level 6 Unfinished!", Toast.LENGTH_SHORT).show();
                    finish(); // Return to SelectLevelActivity
                } else {
                    Toast.makeText(this, "Not logged in!", Toast.LENGTH_SHORT).show();
                }
